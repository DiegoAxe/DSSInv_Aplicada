...
<table>
    ...
    <tr>
        ...
        <td class="btns">
            <a href="<?php echo e(route('cliente.edit', ['id' => $cli->id])); ?>" class="btn-second">Modificar</a>
            <a href="<?php echo e(route('cliente.destroy', ['id' => $cli->id])); ?>" class="btn-second">Eliminar</a>
        </td>
    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ulise\Downloads\dss-inv-aplicada\resources\views/index.blade.php ENDPATH**/ ?>